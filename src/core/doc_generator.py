...
class DocumentGenerator:
    ...
    def save_narration_to_word(self, script_text, original_doc_path):
        """
        ...
        workspace_dir = os.path.dirname(original_doc_path)
        base_name = os.path.basename(original_doc_path).replace(".pdf", "")
