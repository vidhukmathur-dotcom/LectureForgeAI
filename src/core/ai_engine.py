...
class AIEngine:
    ...
    def _request_narration(self, extracted_slide_text, total_slides, retry_correction=None):
        system_instruction = (
            ...
            "4. IMAGE-ONLY SLIDES: Some slides may have little or no extractable text "
            "(e.g. a photo, chart, or diagram slide). For these, write a brief natural "
            "transition line acknowledging the visual (e.g. 'Let's take a moment to look "
            "at this visual before moving forward.') rather than leaving that slide's entry "
            "empty or inventing detailed content you cannot actually see.\n\n"
